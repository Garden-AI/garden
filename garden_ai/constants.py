...
class GardenConstants:
    ...
    PREMADE_IMAGES = {
        ...
        "3.8-tensorflow": "maxtuecke/garden-ai:python-3.8-jupyter-tf",
        "3.9-tensorflow": "maxtuecke/garden-ai:python-3.9-jupyter-tf",
        "3.10-tensorflow": "maxtuecke/garden-ai:python-3.10-jupyter-tf",
        "3.11-tensorflow": "maxtuecke/garden-ai:python-3.11-jupyter-tf",
