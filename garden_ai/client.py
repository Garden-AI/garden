...
class GardenClient:
    ...
    def _register_and_publish_from_user_image(
        ...
        - full_image_uri: str
            ...
            notebook. This image should have both the final `"session.pkl"` and
            `"metadata.json"` files generated by `save_session_and_metadata`
        ...
        metadata = extract_metadata_from_image(docker_client, full_image_uri)
