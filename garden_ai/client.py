...
class GardenClient:
    ...
    def _register_and_publish_from_user_image(
        ...
        - notebook_image_metadata: NotebookImageMetadata
            A dataclass of string fields. Includes the raw notebook,
            the original base image name and location, and the full image location.
        ...
        container_uuid = UUID(
            self.compute_client.register_container(
                notebook_image_metadata.image_location, "docker"
            )
        )
        ...
        for key, record in metadata.items():
            ...
            record["notebook"] = notebook_image_metadata.notebook
            record["base_image_uri"] = notebook_image_metadata.base_image_uri
            record["full_image_uri"] = notebook_image_metadata.image_location
